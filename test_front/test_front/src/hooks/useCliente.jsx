...
function useCliente() {
    ...
    const getListadoDeUsuarios = async () => {
        try {
            setLoading(true);
            const response = await axios.get("http://localhost:9001/api/usuario/todos-los-usuarios");
    ...
    const handleSubmit = async (e) => {
        ...
        axios.post("http://localhost:9001/api/usuario/crear-usuario", formData, {
            headers: {
    ...
    const actualizar = () => {
        axios.put(`http://localhost:9001/api/usuario/actualizar-usuario`, cliente)
            .then((res) => {
                Swal.fire({
                    icon: 'success',
    ...
    const deleteCliente = (cliente) => {
        axios.delete(`http://localhost:9001/api/usuario/borrar-usuario`, { data: cliente })
            .then((res) => {
                Swal.fire({
                    icon: 'success',
